...
const AiSummarySheet = forwardRef(function AiSummarySheet({ summary, onRegenerate, onReport, onDone }, ref) {
  ...
  return sheet(
    <BottomSheetScrollView contentContainerStyle={{ paddingHorizontal: 22, paddingBottom: 30 }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12 }}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text variant="bodySm" color="ink2" style={{ marginTop: 2 }}>
            Generated by AI — check it over before you build from it. Everything here is
            editable.
          </Text>
        </View>
      </View>
      ...
      <View style={{ gap: 10, marginTop: 26 }}>
        ...
        {/* The in-app reporting path Play requires for AI output, at the moment
            the user is actually looking at what the model produced. */}
        {onReport ? (
          <Button title="Report this design" variant="ghost" icon="warning" iconPosition="left" onPress={onReport} />
        ) : null}
      </View>
