...
export const ASSETS = [
  ...
  // --- validation batch: small spread across categories to prove the
  // pipeline + realistic 2D/3D rendering fix end-to-end before adding more ---
  {
    slug: 'ph-bookshelf-01',
    source: 'polyhaven',
    sourceId: 'wooden_bookshelf_worn',
    name: 'Worn Wooden Bookshelf',
    kind: 'bookshelf',
    category: 'Furniture',
    price: 260,
    cost: 35,
    premium: true,
    tags: ['bookshelf', 'shelf', 'storage', 'wood'],
  },
  {
    slug: 'ph-dining-table-01',
    source: 'polyhaven',
    sourceId: 'dining_table',
    name: 'Dining Table',
    kind: 'table',
    category: 'Furniture',
    price: 340,
    cost: 40,
    premium: true,
    tags: ['table', 'dining table', 'wood'],
  },
  {
    slug: 'ph-dining-chair-01',
    source: 'polyhaven',
    sourceId: 'dining_chair_02',
    name: 'Dining Chair',
    kind: 'chair',
    category: 'Furniture',
    price: 95,
    cost: 20,
    premium: true,
    tags: ['chair', 'dining chair', 'seat'],
  },
  {
    slug: 'ph-bed-01',
    source: 'polyhaven',
    sourceId: 'GothicBed_01',
    name: 'Gothic Bed',
    kind: 'bed',
    category: 'Furniture',
    price: 780,
    cost: 55,
    premium: true,
    tags: ['bed', 'bedroom', 'vintage', 'wood'],
  },
  {
    slug: 'ph-potted-plant-01',
    source: 'polyhaven',
    sourceId: 'potted_plant_01',
    name: 'Potted Plant',
    kind: 'plant',
    category: 'Decor',
    price: 45,
    cost: 15,
    premium: false,
    tags: ['plant', 'potted plant', 'decor', 'green'],
  },
  {
    slug: 'ph-nightstand-01',
    source: 'polyhaven',
    sourceId: 'ClassicNightstand_01',
    ...
    cost: 20,
    premium: true,
    tags: ['nightstand', 'bedside table', 'wood'],
  },
  {
    slug: 'ph-desk-01',
    source: 'polyhaven',
    sourceId: 'SchoolDesk_01',
    name: 'School Desk',
    kind: 'desk',
    category: 'Furniture',
    price: 180,
    cost: 25,
    premium: true,
    tags: ['desk', 'office', 'study', 'wood'],
  },
  {
    slug: 'ph-desk-lamp-01',
    source: 'polyhaven',
    sourceId: 'desk_lamp_arm_01',
    name: 'Desk Lamp',
    kind: 'lamp',
    category: 'Electrical',
    price: 55,
